    ...
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 order-lg-2 text-white showcase-img"
                 style="background-image: url('vendor/landing-page/img/bg-showcase-1.jpg');"></div>
        ...
        <div class="row no-gutters">
            <div class="col-lg-6 text-white showcase-img" style="background-image: url('vendor/landing-page/img/bg-showcase-2.jpg');"></div>
        ...
        <div class="row no-gutters">
            <div class="col-lg-6 order-lg-2 text-white showcase-img"
                 style="background-image: url('vendor/landing-page/img/bg-showcase-3.jpg');"></div>
            <div class="col-lg-6 order-lg-1 my-auto showcase-text">
